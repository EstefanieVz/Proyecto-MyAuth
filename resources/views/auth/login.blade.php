<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <x-text-input id="email" class="block mt-1 w-full dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-orange-600 focus:ring-orange-500 dark:focus:ring-orange-600" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
...
{{-- Aqui se cambia el color del label en el inicio y registro de sesión --}}
